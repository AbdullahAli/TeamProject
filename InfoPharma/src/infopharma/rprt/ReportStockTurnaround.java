...
public class ReportStockTurnaround extends GeneralReport
{
	...
	private void addProductDetails(Document document) throws BadElementException, DocumentException {               
		...
		table.addCell(c2);
                ...
                PdfPCell c3 = new PdfPCell(new Phrase("Current Stock"));
		...
		ArrayList<ArrayList<String>> products = rprtDBAccess.getStockTurnAroundReport();
                ...
                for(int i=0; i < products.size(); i++)
                {
                    ...
                    table.addCell(product.get(2)); // stock
