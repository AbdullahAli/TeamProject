 ...
 * @author Abdullah
 */
public class ViewLowStockNotification extends InfoPharmaPanel{
    private static InfoPharmaFrame frame;
    private MiscDBAccess miscDBAccess;
	
    public ViewLowStockNotification(InfoPharmaFrame mainMenuFrame)
    {
    ...
    public void populateLatePayments()
    {
        ...
        tblLowStock.setModel(new DefaultTableModel(miscDBAccess.getLowStock().get(0), miscDBAccess.getLowStock().get(1)));
        System.out.println("table filled");
        tblLowStock.updateUI();
    }
    ...
    private void initComponents() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/infopharma/misc/images/lowstocknotification.png"))); // NOI18N
